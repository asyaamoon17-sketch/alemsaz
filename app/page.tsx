  ...
  Русский: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "Сегодня имя Курманғазы носит Казахская национальная консерватория в Алматы и Государственный академический оркестр народных инструментов. Его жизнь доказала: можно запереть человека в каменных стенах, но невозможно заковать в кандалы музыку, которая выражает дух целого народа."
          ]
        }
      ]
    },
  ...
  Қазақша: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "Құрманғазы 1823 жылы Бөкей Ордасында кедей көшпелі Сағырбайдың отбасында дүниеге келген. Отбасының тұрмысы өте ауыр болғандықтан, ол жас кезінен еңбек етуге мәжбүр болды.",
            "Жасөспірім кезінде Құрманғазы домбыраны меңгеруге бел буды. 1841 жылы, он сегіз жасында, Құрманғазы атақты күйші Ұзақтан білім алу үшін туған үйінен аттанып, ел аралаған музыканттық жолын бастады.",
            "XIX ғасырдың екінші жартысы Құрманғазы үшін ауыр сынақтарға толы кезең болды. Ол бірнеше рет тұтқындалып, қудалауға ұшырады. Соған қарамастан шығармашылық жолын жалғастырды.",
        ...
        },
        {
          ...
          paragraphs: [
            "Құрманғазы қазақ мәдениетіне үлкен өзгеріс әкеліп, домбырада орындау өнерін аса жоғары кәсіби деңгейге көтерді."
          ]
        },
        {
        ...
        },
        {
          ...
          paragraphs: [
            "Бүгінде Алматыдағы Қазақ ұлттық консерваториясы мен Мемлекеттік академиялық халық аспаптар оркестрі Құрманғазының есімін иеленеді."
          ]
        }
      ]
    },
  ...
  English: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "Kurmangazy Sagyrbayuly (1823–1896) was a brilliant composer, virtuoso performer and one of the key figures in the development of Kazakh instrumental music."
          ]
        },
        {
          heading: "A Life Through Hardship to Recognition",
          paragraphs: [
            "Kurmangazy was born in 1823 in the Bukey Horde into the family of a poor nomad. Music became an important source of inspiration during his difficult childhood.",
            "As a teenager, Kurmangazy decided to master the dombra. In 1841 he left home to study with the famous kuiishi Uzak.",
            "The second half of the nineteenth century brought serious trials. Kurmangazy was repeatedly persecuted and imprisoned, yet he continued his creative journey.",
        ...
        },
        {
          ...
          paragraphs: [
            "Kurmangazy brought a true revolution to traditional music and raised dombra performance to an exceptionally high artistic level."
          ]
        },
        {
          heading: "The Tökpe Tradition",
          paragraphs: [
            "Kurmangazy became one of the defining figures of the western Kazakh performance tradition known as tökpe."
          ]
        },
        {
          heading: "Expanding the Possibilities of the Dombra",
          paragraphs: [
            "His distinctive performance techniques demonstrated how two strings could express an extraordinary range of emotions."
          ]
        },
        {
          heading: "Passing the Tradition to Future Generations",
          paragraphs: [
            "Kurmangazy left behind a strong circle of students and followers. The most famous among them was Dina Nurpeisova."
          ]
        },
        {
          heading: "Recognition Beyond the Steppe",
          paragraphs: [
            "Today, major Kazakh musical institutions bear Kurmangazy's name, preserving his legacy for future generations."
          ]
        }
      ]
    },
...
export default function Home() {
  ...
  const articles = encyclopediaArticles[lang];
