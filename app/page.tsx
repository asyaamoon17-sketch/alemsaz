...
const dinaSections = {
  ...
  kz: [
    {
      ...
      paragraphs: [
        "Тарихта ұстазын жай ғана қайталамай, рухының күші мен таланты жағынан онымен теңескен шәкірттер көп кездесе бермейді. Дина Нұрпейісова (1861–1955) — осындай ерекше тұлға. Ғасырға жуық өмір сүрген ол ұлы Құрманғазының дәстүрін дәуірлердің өзгерісі, революциялар мен соғыстар арқылы жеткізіп, ежелгі көшпелі мәдениет пен заманауи музыканың арасындағы тірі көпірге айналды. Құрманғазыны «күйдің атасы» деп атаса, Дина — сөзсіз «домбыраның ханшайымы».",
      ],
    },
    {
      heading: "Бүлікшіл күйші таңғалдырған қыз",
      paragraphs: [
        "Дина 1861 жылы Нарын құмдарында (қазіргі Батыс Қазақстан облысы) дүниеге келген. Музыка оны бала кезінен қоршады: әкесі Кенже домбырада өте жақсы ойнаған, ал әпкелері тамаша ән айтқан. Бірақ Дина олардың бәрінен асып түсті. Тоғыз жасында-ақ кішкентай домбырашы қыз туралы бүкіл өңір білетін.",
        "Оның өміріндегі ең маңызды бетбұрыс Құрманғазы олардың ауылына келген кезде болды. Тоғыз жасар Динаның орындауын естіген, түрмелер мен қуғын-сүргінді бастан өткерген қатал күйші қатты таңғалды. Ол қыздан жай ғана баланы емес, ерекше дарынды көрді. Сол күннен бастап он бір жыл бойы Құрманғазы оның ұстазы болды. Ол Динаны сайыстарға ертіп барып, орындаушылық техникасын жетілдірді және күйлерін «қолдан қолға» жеткізді, өйткені ол кезде далада нота жазуы болмаған.",
      ],
    },
    {
      heading: "Сынақтар арқылы: тағдыр соққыларына қарсы домбыра",
      paragraphs: [
        "XIX ғасырдағы дала әйелінің өмірі қатаң дәстүрлерге бағынды. Динаны ұзатып, оның балалары дүниеге келді. Көп ұзамай күйеуі Нұрпейіс қайтыс болып, әмеңгерлік дәстүр бойынша оның ағасы Шапекке тұрмысқа шығуға мәжбүр болды. Тұрмыс пен ауыр көшпелі өмір оның музыкалық жолын біржола тоқтататындай көрінді.",
        "Бірақ Дина домбырасынан қол үзбеді. Ол өмір өте қиын болған кезде де, далада аштық жайлаған кезде де, қалыптасқан империя күйреген кезде де ойнады. Сонымен қатар өз күйлерін шығара бастады. Оның «Бұлбұл» сияқты алғашқы күйлері нәзіктік пен әйелге тән әсемдікті Құрманғазы мектебіне тән қуатты қағыспен үйлестірді.",
      ],
    },
    {
      heading: "75 жаста келген шынайы даңқ",
      paragraphs: [
        "Дина Нұрпейісованың өмірбаянындағы ең таңғаларлық кезең — оның «екінші дүниеге келуі». 1937 жылы көрнекті қазақ музыкатанушысы Ахмет Жұбанов ұлы Құрманғазының шәкірттерін іздеуге кірісті. Ол шалғай ауылдардың бірінен 75 жастағы, жасына қарамастан саусақтарының ғажайып шапшаңдығын және ақыл-ойының анықтығын сақтаған әжейді тапты.",
        "Жұбанов Динаны Алматыға алып келді. Сол жылдың күзінде ол Бірінші бүкілқазақстандық халық таланттарының слетінде сахнаға шықты. Ақ кимешек киген қарт әйел домбырасын қолына алып, ішектерге қағыс жасағанда, зал тып-тыныш болды. Оның саусақтарынан даланың таза әрі бастапқы қуаты төгілді. Ол бірінші орынға ие болып, бірден ұлттық қаһарманға айналды.",
      ],
    },
    {
      heading: "Жеңіс қаруы және әлемдік мойындау",
      paragraphs: [
        "1939 жылы Мәскеуде халық аспаптарында орындаушылардың Бүкілодақтық байқауы өтті. Ол кезде Дина 78 жаста еді. Қазылар алқасының төрағасы, ұлы кеңестік композитор Рейнгольд Глиэр оның орындауын таңданыспен тыңдады. Қазақ даласынан келген қарт күйші бүкіл Кеңес Одағының жүздеген жас виртуоздарының арасынан бірінші орын алды.",
        "Ұлы Отан соғысы басталған кезде Динаның жасы сексеннен асқан еді. Бірақ ол шет қалмады. 1941 жылы ол майданға аттанған сарбаздарға рух берген қуатты марштық «Ана бұйрығы» күйін жазды. Ол әскерге шақырылушылардың алдында өнер көрсетіп, домбыраның да қару бола алатынын дәлелдеді.",
      ],
    },
    {
      heading: "Ұмытылудан сақталған мұра",
      paragraphs: [
        "Дина Нұрпейісова 94 жыл өмір сүріп, өмірінің соңғы күндеріне дейін домбыра тартты. Оның ең басты еңбегі — Құрманғазының ондаған күйін феноменалды жадында сақтап, музыкатанушыларға жеткізуі. Дина болмағанда, бұл күйлердің бір бөлігі тарих үшін мәңгіге жоғалар еді.",
        "Оның «Көген түп», «Сталин күйі» (кейін «Еңбек майданы» деп өзгертілген), «Делдірең» сияқты шығармалары әлемдік музыкалық мәдениеттің алтын қорына енді. Дина шынайы таланттың жасқа бағынбайтынын, ал дұрыс қолдағы домбыраның қос ішегі кез келген империядан ұзақ өмір сүре алатынын дәлелдеді.",
      ],
    },
  ],
  ...
  en: [
    {
      heading:
        "Guardian of the Steppe Flame: How Dina Nurpeisova Preserved Kurmangazy's Music and Became the Queen of the Dombra",
      paragraphs: [
        "History knows few examples of a successor who does not simply copy a teacher, but becomes their equal in strength of spirit and talent. Dina Nurpeisova (1861–1955) was exactly such a phenomenon. Living for almost a century, she carried the traditions of the great Kurmangazy through changing eras, revolutions and wars, becoming a living bridge between ancient nomadic culture and the modern world. If Kurmangazy is called the “father of kui”, Dina is undoubtedly the “queen of the dombra”.",
      ],
    },
    {
      heading: "The Girl Who Amazed the Rebel",
      paragraphs: [
        "Dina was born in 1861 in the Naryn sands, in what is now the West Kazakhstan Region. Music surrounded her from childhood: her father Kenже was an excellent dombra player, while her sisters were talented singers. But Dina surpassed them all. By the age of nine, the whole area was already talking about the young virtuoso.",
        "The most important turning point in her life came when Kurmangazy himself arrived in their aul. Hearing nine-year-old Dina play, the stern kuiishi, who had endured imprisonment and persecution, was deeply impressed. He saw in her not merely a child, but extraordinary talent. From that moment and for the next eleven years, Kurmangazy became her mentor. He took her to musical competitions, refined her technique and passed his kui to her directly, because written musical notation was not yet used in the steppe.",
      ],
    },
    {
      heading: "Through Hardship: The Dombra Against the Blows of Fate",
      paragraphs: [
        "The life of a woman in the nineteenth-century steppe was governed by strict traditions. Dina was married and had children. Soon her husband Nurpeis died, and according to the custom of amengerlik, she had to marry his brother Shapek. Everyday life and the difficult nomadic existence seemed likely to bury her musical career forever.",
        "But Dina never parted with her dombra. She played when life became unbearable, when famine spread across the steppe and when the familiar empire was collapsing. She also began composing her own music. Her early kui, including “Bulbul” (“The Nightingale”), combined tenderness and feminine grace with the extraordinary power of the Kurmangazy school.",
      ],
    },
    {
      heading: "True Fame at the Age of 75",
      paragraphs: [
        "The most remarkable part of Dina Nurpeisova's biography was her “second birth”. In 1937, the outstanding Kazakh musicologist Akhmet Zhubanov decided to search for the students of the great Kurmangazy. In a remote aul, he found a 75-year-old woman who, despite her age, had preserved extraordinary finger agility and a clear mind.",
        "Zhubanov brought Dina to Alma-Ata. In the autumn of the same year, she appeared on stage at the First All-Kazakhstan Gathering of Folk Talents. When the elderly woman in a traditional white kimeshek took the dombra and struck its strings, the hall fell silent. Pure, primordial energy of the steppe poured from beneath her fingers. She won first place and instantly became a national heroine.",
      ],
    },
    {
      heading: "A Weapon of Victory and International Recognition",
      paragraphs: [
        "In 1939, Moscow hosted an All-Union showcase of performers on folk instruments. Dina was already 78 years old. The chairman of the jury, the great Soviet composer Reinhold Glière, listened to her performance with astonishment. The elderly musician from the Kazakh steppe took first place among hundreds of young virtuosos from across the Soviet Union.",
        "When the Great Patriotic War began, Dina was already well over eighty. Yet she did not remain on the sidelines. In 1941 she composed the kui “Ana buirygy” (“A Mother's Command”), a powerful, march-like work that inspired soldiers leaving for the front. She performed for recruits, proving that her dombra could also be a weapon.",
      ],
    },
    {
      heading: "A Legacy Saved from Oblivion",
      paragraphs: [
        "Dina Nurpeisova lived for 94 years and played the dombra until the final days of her life. Her greatest achievement was preserving dozens of Kurmangazy's kui in her extraordinary memory and passing them on to musicologists. Without her, many of these works might have been lost to history forever.",
        "Her own compositions — “Kogen tup”, “Stalin kuyi” (later renamed “Enbek Maidany”), and “Deldiren” — became part of the golden treasury of musical culture. Dina proved that true talent has no age, and that the two strings of a dombra in the right hands can outlive any empire.",
      ],
    },
  ],
};
...
function getArticles(lang: Language): Article[] {
  if (lang === "Русский") {
    return [
      ...
      },
      {
        ...
        category: "kuiyshi",
        description:
          "Великая казахская кюйши и композитор, сохранившая традиции Курмангазы и ставшая одной из главных фигур домбрового искусства.",
        readTime: "8 мин",
  ...
  if (lang === "Қазақша") {
    return [
      ...
      },
      {
        ...
        subtitle: "Домбыраның ханшайымы",
        icon: "🎼",
        image: "/DinaNurpeisova.jpeg",
        category: "kuiyshi",
        description:
          "Құрманғазының дәстүрін сақтап, домбыра өнерінің аса көрнекті тұлғасына айналған ұлы қазақ күйші-композиторы.",
        readTime: "8 мин",
  ...
  return [
    ...
    },
    {
      ...
      category: "kuiyshi",
      description:
        "A great Kazakh kuiishi and composer who preserved Kurmangazy's tradition and became one of the most important figures in dombra music.",
      readTime: "8 min",
