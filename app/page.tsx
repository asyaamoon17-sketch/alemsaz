...
const aboutTexts = {
  Русский: {
    ...
    founder: "Основатель и автор проекта — Асемай Аль-Фараби",
  },
  ...
  Қазақша: {
    ...
    paragraphs: [
      <><strong>ALEM.MUSIC</strong> — қазақ музыкасын әр адамға жақын әрі қолжетімді ету үшін құрылған кеңістік.</>,
      ...
      <>ALEM.MUSIC <strong>білім беруді, музыканы және мәдениетті</strong> біріктіреді. Мұнда ұлттық аспаптарды үйреніп қана қоймай, олардың тарихы, дәстүрлері, шығармалары, композиторлары және қазақ музыкалық өнерінің дамуына үлес қосқан музыканттар туралы білуге болады.</>,
      <>Біз үшін музыкалық мұраны жай ғана сақтау емес, оған <strong>өмір сүруге және әрі қарай дамуға мүмкіндік беру</strong> маңызды. Қазақ музыкасының терең тарихы мен қайталанбас үні бар, және біз оның кез келген жастағы әрі кез келген ұлттағы адамдарға қызықты бола алатынын көрсеткіміз келеді.</>,
      ...
      <><strong>ALEM.MUSIC — қазақ музыкасымен танысудан оны түсінуге, орындауға және сүюге дейінгі жол.</strong></>,
      ...
      <><strong>Қазақ музыкасын әлемге ашамыз. Әлемді қазақ музыкасына ашамыз.</strong></>,
    ],
    founder: "Жобаның негізін қалаушы және авторы — Асемай Аль-Фараби",
  },
  ...
  English: {
    ...
    paragraphs: [
      <><strong>ALEM.MUSIC</strong> is a space created to make Kazakh music closer and more accessible to everyone.</>,
      ...
      <>ALEM.MUSIC brings together <strong>education, music and culture</strong>. Here, users can not only study traditional instruments, but also learn about their history, traditions, works, composers and musicians who have contributed to the development of Kazakh musical art.</>,
      <>For us, it is important not only to preserve musical heritage, but also to <strong>give it the opportunity to live and continue developing</strong>. Kazakh music has a deep history and a unique sound, and we want to show that it can be interesting to people of any age and nationality.</>,
      ...
      <><strong>ALEM.MUSIC is a journey from discovering Kazakh music to understanding it, performing it and loving it.</strong></>,
      ...
      <><strong>We open Kazakh music to the world. And we open the world to Kazakh music.</strong></>,
    ],
    founder: "Founder and creator of the project — Asemay Al-Farabi",
  },
};
